...
class CustomBottomNavigationBar extends StatefulWidget {
  ...
  static BottomNavigationBarType _type(
    ...
    //aqui agregas la cantidad de iconos que quieres que se muetren con nombre :P
    return items.length <= 5 ? BottomNavigationBarType.fixed : BottomNavigationBarType.shifting;
  }
