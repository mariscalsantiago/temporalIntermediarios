...
class LoginCambiarContrasena extends StatefulWidget {
  ...
  const LoginCambiarContrasena({Key key, this.responsive}) : super(key: key);
  @override
  _LoginCambiarContrasenaState createState() => _LoginCambiarContrasenaState();
}

class _LoginCambiarContrasenaState extends State<LoginCambiarContrasena> {
