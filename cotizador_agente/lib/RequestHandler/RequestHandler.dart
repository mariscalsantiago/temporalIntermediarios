...
class RequestHandler {
      ...
      case Method.GET:
        try {
          ...
          final MetricsPerformance metricsPerformance =
              MetricsPerformance(http.Client(), fullURL, HttpMethod.Get);
          final http.Request requestPerf =
              http.Request("Base", Uri.parse(fullURL));
          metricsPerformance.send(requestPerf);
  ...
  static Future<MyResponse> redirectedRequest(
      String redirectURL, MyRequest request) async {
