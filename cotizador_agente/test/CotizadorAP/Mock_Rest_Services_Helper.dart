...
getNegociosOperables(Map<String,dynamic> headers, Map<String, dynamic> body) async {

  final response = await http.post(negocios + Constants.NEGOCIOS_OPERABLES, headers: headers, body: jsonEncode(body).toString());
...
Future<List<Cotizadores>> getCotizadores(Map<String,dynamic> headers, Map<String, dynamic> body) async {
   List<Cotizadores> listCotizadores = List<Cotizadores>();
   List<dynamic> list;

   final response = await http.post(baseURL + Constants.COTIZADORES, headers: headers, body: jsonEncode(body).toString());
